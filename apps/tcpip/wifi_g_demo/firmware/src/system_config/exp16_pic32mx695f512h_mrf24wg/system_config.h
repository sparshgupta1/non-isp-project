...
//   This following declaration makes MRF use _EXTERNAL_1_VECTOR. It does not mean that we are actually using SPI1. 
//   In Wi-Fi G Demo (PIC32MX695F512H), we are actually using SPI2. 
